class ShoppingCart {
    ...
    async checkout() {
        ...
        // Store cart info in localStorage for reference
        localStorage.setItem('gripgod_pending_booking', JSON.stringify({
            items: this.items,
            total: this.getTotal(),
            timestamp: Date.now()
        }));

        // Redirect to Swipe Simple payment link for $50 deposit
        window.location.href = 'https://swipesimple.com/links/lnk_0007ac0fa9e194f92cee9db673a34c27';
    }
